            ...
            <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <button 
                  ...
                  className="p-6 border-2 rounded-xl text-left hover:border-blue-500 hover:bg-blue-50 transition group border-slate-200"
                >
            ...
            <div className="animate-fade-in">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                {sports.map((sport) => (
                  <button
                    ...
                    className={`py-3 px-4 rounded-lg border font-medium transition text-center focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                      selectedSport === sport
              ...
              <div className="space-y-3">
                {['beginner', 'intermediate', 'advanced'].map((level) => (
                  <label
                    key={level}
                    className={`flex items-center p-4 border rounded-lg cursor-pointer hover:bg-slate-50 ${
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3 mb-8">
                {[
                  ...
                  <label key={goal} className="flex items-center gap-3 p-3 hover:bg-slate-50 rounded-lg cursor-pointer">
                    <input type="checkbox" className="rounded text-blue-600 w-5 h-5 border-slate-300" />
              ...
              <div className="flex justify-between mt-8">
                ...
                <button 
                  onClick={onComplete}
                  className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-bold shadow-lg shadow-blue-500/30 transition transform hover:-translate-y-0.5"
                >
                  Complete Setup
                </button>
              </div>
